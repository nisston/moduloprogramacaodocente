# -*- coding: utf-8 -*-
"""Aqui é apresentado um exemplo de como estaria estruturado
a lista prática para ser aplicada a turma.

# Estrutura do conteúdo a ser dado [Lista]
...
numeros = [1, 2, 3, 4, 5]
nomes = ["João", "Maria", "Pedro", "Nisston"]
print(nomes)
...
"""# Exemplos para a lista de exercício"""

# Estrutura para leitura e preenchimento de uma lista (Vetor)

# Criando um vetor em branco
pressao_compressor = []

# para ler 3 entradas e adicionar no vetor
for i in range(0, 3):
  elemento = float(input("Informe a pressão: "))
  pressao_compressor.append(elemento)

# impressão do conteúdo do vetor
print(pressao_compressor)